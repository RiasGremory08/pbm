        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                SmartphoneData smartphoneData = SmartphoneData(
                  kode: tecKode.text,
                  nama: tecNama.text,
                  seri: tecSeri.text,
                  jenisJaringan: selectValue,
                  produsen: selectItem,
                );

                
                // Lakukan sesuatu dengan data, seperti melewatkan ke layar lain
                Navigator.pushNamed(
                  context,
                  '/resultScreen',
                  arguments: smartphoneData,
                );
              },
